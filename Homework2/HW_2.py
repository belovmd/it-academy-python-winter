...
# Вводится M рублей и N копеек цена, а также количество L товара Посчитайте общую цену
...
print('There are {up} capital letters and {low} '
        'lowercase letters in the proverb'.format(up=count, low=(len(string) - count)))
...
# 7 Определите, является ли число палиндромом (читается слева направо и справа налево одинаково).
